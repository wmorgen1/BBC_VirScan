...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240515 - CMV VARscore dotplot by breastfeeding.jpeg",
       dotplot,
       scale = 1,
       height = 1.5,
       width = 1.5,
...
fisher.test(matrix(data = c(257, 391,
...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240515 - child CMV VARscore vs time by feeding dotplot.jpeg",
       timeplot,
       scale = 1,
       height = 1.5,
       width = 3,
...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240515 - HSV1 VARscore dotplot by breastfeeding.jpeg",
       dotplot,
       scale = 1,
       height = 1.5,
       width = 1.5,
...
fisher.test(matrix(data = c(167, 23,
                            543,  81), nrow = 2)) # any breastfeeding vs formula only. No difference
...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240515 - child HSV1 VARscore vs time by feeding dotplot.jpeg",
       timeplot,
       scale = 1,
       height = 1.5,
       width = 3,
