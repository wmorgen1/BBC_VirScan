...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240424 - pneumovirus VARscore dotplot.jpeg",
       dotplot,
       scale = 1,
       height = 2,
       width = 3.5,
...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240424 - child pneumovirus VARscore vs time dotplot.jpeg",
       timeplot,
       scale = 1,
       height = 1.5,
       width = 4,
...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240424 - child pneumo VARscore vs date dotplot - seasonality and outbreaks.jpeg",
       dateplot,
       scale = 1,
       height = 2,
       width = 4,
...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240424 - child pneumovirus seropositivity by age.jpeg",
       sero_byage,
       scale = 1,
       height = 1,
       width = 2,
...
hsv_serobyage = hsv_VAR %>% filter(Plasma_type == "child") %>%
  group_by(taxon_species, Plasma_type, years, ID) %>%
  summarise(vir_score = max(vir_score)) %>%
  mutate(age_group = case_when(
    years < 1 ~ "0 - 1",
    years < 2 ~ "1 - 2",
...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240424 - RSV cross reactivity.jpeg",
       HSV_xreact,
       scale = 1,
       height = 1.5,
       width = 3,
