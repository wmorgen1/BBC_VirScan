...
ggsurvplot(survfit(Surv(time = years_0, time2 = years_1, type = 'interval2') ~ preterm1,
                   data = CMV_model_data_2), data = CMV_model_data_2,
           size = 1,                 # change line size
           linetype = c(1, 1),
           palette =
           ...
           legend.labs =
             c("Term", "Preterm"),    # Change legend labels
...
ictest(Surv(time = years_0, time2 = years_1, type = 'interval2') ~ `preterm1`,
       data = CMV_model_data_2)
