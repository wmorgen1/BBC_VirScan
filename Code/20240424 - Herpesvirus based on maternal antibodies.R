...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240515 - CMV VARscore dotplot by maternal status.jpeg",
       dotplot,
       scale = 1,
       height = 1.5,
       width = 1.5,
...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240515 - HSV1 VARscore dotplot by maternal status.jpeg",
       dotplot,
       scale = 1,
       height = 1.5,
       width = 1.5,
...
fisher.test(matrix(data = c(105, 723,
                            5, 130), nrow = 2))
...
fisher.test(matrix(data = c(282, 563,
                            15, 103), nrow = 2))
...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240515 - child CMV VARscore vs time by mom serostatus dotplot.jpeg",
       timeplot,
       scale = 1,
       height = 1.5,
       width = 3,
...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240515 - child HSV1 VARscore vs time by mom serostatus dotplot.jpeg",
       timeplot,
       scale = 1,
       height = 1.5,
       width = 3,
