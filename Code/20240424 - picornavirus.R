...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240424 - picornavirus VARscore dotplot.jpeg",
       dotplot,
       scale = 1,
       height = 2,
       width = 7.5,
...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240424 - child picornavirus VARscore vs time dotplot.jpeg",
       timeplot,
       scale = 1,
       height = 3,
       width = 5,
...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240424 - child picorna VARscore vs date dotplot - seasonality and outbreaks.jpeg",
       dateplot,
       scale = 1,
       height = 3,
       width = 7,
...
ggsave("C:/Users/wmorgen1/Documents/Larman_Lab/BBC/Figures/20240424 - child picornavirus seropositivity by age.jpeg",
       sero_byage,
       scale = 1,
       height = 1.5,
       width = 5,
...
ggsave("BBC/Figures/20250930 - RVA EVB cross reactivity.jpeg",
       xreact,
       scale = 1,
       height = 1.5,
       width = 2.5,
...
pairs_plot <- ggpairs(data = HSV1_HSV2,
        columns = c(3:8),
        #mapping = aes(alpha = .1)
...
ggsave("BBC/Figures/20251018 - Entero Pairs Plot.jpeg",
       pairs_plot,
       scale = 1,
       height = 5.5,
       width = 5.5,
